...
public interface TreeStructure extends NodeKind {
	...
	/**
	 * レシーバ・オブジェクトが{@link TreeStructure.Root}のインスタンスかどうか判定する.
	 * @return 該当する場合{@code true}
	 */
	boolean isRoot();
	/**
	 * レシーバ・オブジェクトが{@link TreeStructure.Branch}のインスタンスかどうか判定する.
	 * @return 該当する場合{@code true}
	 */
	boolean isBranch();
	/**
	 * レシーバ・オブジェクトが{@link TreeStructure.Leaf}のインスタンスかどうか判定する.
	 * @return 該当する場合{@code true}
	 */
	boolean isLeaf();
}
